...
public class InputGraphicMaze extends JFrame  
{
	...
	Scanner in=new Scanner(integers);  //scanner to initialize keyboard
        M=in.nextInt(); N=in.nextInt();  // values for # rows and columns
        L=new LinkedList<Node>();   //I think this is a node element declaration of built in linked list type
 
	C=new Intcoll[N*M+1]; int k;//array of intcolls
	for (k=1; k<=M*N; k++) 
